...
################################################################################
# utility to allow construction of TypedList with Float/Int types
# (always promoted to float)
    ...
    def __init__(self, a, b, h, f, k=3, p=False, c=True, e=0):
        ...
        For non-periodic interpolation (p = False)
            if c is True the function is padded to allow accurate eval on:
                [a-e*h, b+e*h]
                (extrapolation is done on [a-e*h, a] and [b, b+e*h],
                be careful!)
    ...
    for mi in numba.prange(m):
        ...
        asx[1] = -25 / 256 + ratx * (
            ...
            * (
                39 / 48 / 2
                + ratx
                * (-13 / 8 / 6 + ratx * (-3 / 2 / 24 + 5 / 8 / 120 * ratx))
            )
        )
        asx[2] = 150 / 256 + ratx * (
            -2250 / 1920
            ...
            * (
                -34 / 48 / 2
                + ratx
                * (34 / 8 / 6 + ratx * (2 / 2 / 24 - 10 / 8 / 120 * ratx))
            )
        )
        asx[3] = 150 / 256 + ratx * (
            2250 / 1920
...
def _compute_bounds1(a, b, h, p, c, e, k):
    if p:
        ...
        u -= (
            u * 1e-15
        )  # the routines can fail when we exactly hit the right endpoint, this
    ...
    for mi in numba.prange(m):
        ...
        asy[1] = -25 / 256 + raty * (
            ...
            * (
                39 / 48 / 2
                + raty
                * (-13 / 8 / 6 + raty * (-3 / 2 / 24 + 5 / 8 / 120 * raty))
            )
        )
        asy[2] = 150 / 256 + raty * (
            -2250 / 1920
            ...
            * (
                -34 / 48 / 2
                + raty
                * (34 / 8 / 6 + raty * (2 / 2 / 24 - 10 / 8 / 120 * raty))
            )
        )
        asy[3] = 150 / 256 + raty * (
            2250 / 1920
    ...
    for mi in numba.prange(m):
        ...
        asz[1] = -25 / 256 + ratz * (
            ...
            * (
                39 / 48 / 2
                + ratz
                * (-13 / 8 / 6 + ratz * (-3 / 2 / 24 + 5 / 8 / 120 * ratz))
            )
        )
        asz[2] = 150 / 256 + ratz * (
            -2250 / 1920
            ...
            * (
                -34 / 48 / 2
                + ratz
                * (34 / 8 / 6 + ratz * (2 / 2 / 24 - 10 / 8 / 120 * ratz))
            )
        )
        asz[3] = 150 / 256 + ratz * (
            2250 / 1920
