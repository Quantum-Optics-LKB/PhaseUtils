...
def monitor_abs_speed(cam: Any, y_range: int) -> tuple:
    ...
    mean_uwr_phase = np.mean(unwr_phase[cut_y-y_range//2:cut_y+y_range//2 , cut_x-mean_range//2:cut_x+mean_range//2], axis = 1)
    mean_dens = np.mean(cont[cut_y-y_range//2:cut_y+y_range//2  , cut_x-mean_range//2:cut_x+mean_range//2], axis = 1)
